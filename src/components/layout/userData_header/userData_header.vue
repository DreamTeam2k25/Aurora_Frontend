...
<section class="w-dvw h-dvh fixed overflow-x-hidden" v-if="studentsStore.open || animateClose">
    ...
    <div @click="studentsStore.state.open = false, studentsStore.state.studentExists = false, authStore.Logout()" class="flex justify-center items-center cursor-pointer pt-20">
